...
const TabFilter = () => {
        ...
        {({ open, close }) => (
          <>
            ...
            >
              ...
              <span className="ml-2">
                {sortOrderStates
                  ? SortProjectData.filter(
                      (i) => i.id === sortOrderStates
                    )[0].name
                  : "Sort Projects"}
              </span>
              {!sortOrderStates.length ? (
                <AiOutlineDown className="w-4 h-4 ml-3" />
              ) : (
  ...
  return (
    <div className="flex lg:space-x-4 w-full justify-between w-full items-center ">

      
      <div className="hidden lg:flex flex-1 space-x-4 w-full justify-end  items-center ">
        <div className="!ml-auto justify-end">{renderTabsSortOrder()}</div>
      </div>
