...
<div class="glide group w-full h-full">
         
         
            <div class="absolute group-hover:opacity-100 transition-all opacity-0 p-2 duration-500  top-[50%] z-10 bg-white rounded-full " data-glide-el="controls">
            <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
                Prev
            </button>
            </div>
            <div class="absolute group-hover:opacity-100 transition-all opacity-0 p-2 duration-500 top-[50%] right-0 z-10 bg-white rounded-full" data-glide-el="controls">
