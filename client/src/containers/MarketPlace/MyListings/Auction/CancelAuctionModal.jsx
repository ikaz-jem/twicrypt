    ...
    return (
      <>
        <div className=" inset-0 flex items-center justify-center">
          ...
          >
          <p className="text-xs text-neutral-200">cancel auction</p>  <i><AiOutlineDelete className="text-red-500  group-hover:text-white transition-all duration-300"/></i>
          </button>
        </div>
              ...
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                >
                  <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-neutral-800 border border-neutral-700 px-6 pb-6 text-left align-middle shadow-xl transition-all">
                    ...
                    >
                      {`you are about to cancel auction of ${nft?.name}`}
                    </Dialog.Title>
                    <div className="mt-2">
