...
const NoAuctions = () => {
    ...
    return (
        ...
        <div className="flex items-center justify-center w-full h-full flex-col ">
            <h1>you have no active auctions</h1>
           ...
           <div className='flex gap-5'>
            ...
            <Link to='/dashboard/marketplace/create-auction' className="inline-flex my-5 justify-center items-center gap-2 rounded-md border border-transparent bg-blue-500 hover:bg-pink-500 px-4 py-2 text-sm font-medium text-white transition-all duration-300">

                <p className="text-white">create Auction</p>
            </Link>
           </div>
        </div>
