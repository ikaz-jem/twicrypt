...
import NftListingDetails from "./NftAuctionDetails";
...
const RenderData = () => {
    ...
    return (
        ...
        <h2 className="pb-5 m-0 text-left text-neutral-700">twicrypt auction</h2>
                        ...
                        {myNfts?.selectedNft &&
                            <div className="flex flex-col w-full lg:w-1/2 gap-5">
                                ...
                                <div className="h-full border-l border-neutral-900 py-5 rounded-2xl" >
                                    ...
                                    {Nfts?.data && myNfts?.selectedNft && <AuctionForm />}
                                </div>
                            </div>
                        }
